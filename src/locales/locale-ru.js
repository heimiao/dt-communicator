...
const messages = {
  ...
  "CHECK_RESOLUTION": "Проверка отсутствия резолюции.",
  "ERROR_RESOLUTION": "Ошибка: внутренняя ошибка проверка разрешения",
  ...
  "BROWSER_SUPPORT_TITLE": "Браузер не поддерживается",
  "BROWSER_SUPPORT_TEXT": "Используемый вами браузер не поддерживается для нашего программного обеспечения. Пожалуйста, смотрите ниже для альтернативного браузера Вы можете использовать. После того как вы выбрали альтернативный браузер вы сможете получить доступ к сессии связь с использованием ИТ.",
  "BROWSER_NAME_EDGE": "EКромки",
  "BROWSER_VERSIONS_EDGE": "Все",
  "BROWSER_NAME_CHROME": "Chrome",
  "BROWSER_VERSIONS_CHROME": "Все",
  "BROWSER_NAME_FIREFOX": "Firefox",
  "BROWSER_VERSIONS_FIREFOX": "Все",
  "BROWSER_NAME_OPERA": "Opera",
  "BROWSER_VERSIONS_OPERA": "Все",
  "MORE_SETTINGS": "Дополнительные настройки",
  "LESS_SETTINGS": "Меньше настроек",
  "YOUR_PASSWORD": "Ваш пароль",
  "VERSION": "Версия: ",
  "GIT_REV": "Гит Rev: ",
  "POWERED_BY": "Питаться от: ",
  "PREVIOUS": "предыдущий",
  "SET_LAYOUT_POSITION": "Установить макет положение .",
  "ENTER_LAYOUT_POSITION": "Пожалуйста, введите макет позиции .",
  "LAYOUT_POSITION": "Макет позиции",
  "DISCONNECTED": "Отключен",
  "CONNECTING": "соединительный",
  "CONNECTED": "Связанный",
  "COM_STATUS": "Состояние связи .",
  "SCREEN_SHARE": "доля экрана",
  "PRESENTER": "ведущий",
  "WATCHING_CANVAS": "Смотря Холст",
  "INPUT_CANVAS": "Ввод Холст",
  "CLEAR_ALERTS": "четкие предупреждения",
  "NO_LOG": "Hет данных журнала",
  "CLICK_DIAL": "Hажмите чтобы набрать",
  "SETTINGS_LOGIN": "Войти , чтобы изменить настройки",
  "SETTINGS_USER": "Пользовательские настройки",
  "SETTINGS_USER_LOGIN": "Вход для изменения настроек пользователя",
  "MENU_INFO": "Информационное меню",
