...
const messages = {
  ...
  "CHECK_RESOLUTION": "Verificar a resolução.",
  "ERROR_RESOLUTION": "Erro: erro interno de resolução de verificação",
  ...
  "BROWSER_SUPPORT_TITLE": "Navegador não suportado",
  "BROWSER_SUPPORT_TEXT": "O navegador que você está usando não é suportada pelo nosso software. Consulte abaixo para browser alternativo que você pode usar. Uma vez que você tenha escolhido um navegador alternativo que você vai ser capaz de acessar a sessão link utilizando.",
  "BROWSER_NAME_EDGE": "Edge",
  "BROWSER_VERSIONS_EDGE": "Todos os",
  "BROWSER_NAME_CHROME": "Chrome",
  "BROWSER_VERSIONS_CHROME": "Todos os",
  "BROWSER_NAME_FIREFOX": "Firefox",
  "BROWSER_VERSIONS_FIREFOX": "Todos os",
  "BROWSER_NAME_OPERA": "Opera",
  "BROWSER_VERSIONS_OPERA": "Todos os",
  "MORE_SETTINGS": "Mais definições",
  "LESS_SETTINGS": "Menos Definições",
  "YOUR_PASSWORD": "Sua senha",
  "VERSION": "Versão: ",
  "GIT_REV": "Git Rev: ",
  "POWERED_BY": "Distribuído por: ",
  "PREVIOUS": "Anterior",
  "SET_LAYOUT_POSITION": "Definir a posição layout.",
  "ENTER_LAYOUT_POSITION": "Por favor, indique a posição layout.",
  "LAYOUT_POSITION": "Posição de layout",
  "DISCONNECTED": "Desligado",
  "CONNECTING": "Ligar",
  "CONNECTED": "Conectado",
  "COM_STATUS": "Status de comunicação.",
  "SCREEN_SHARE": "Compartilhamento de tela",
  "PRESENTER": "Apresentador",
  "WATCHING_CANVAS": "Assistindo Canvas",
  "INPUT_CANVAS": "Canvas de entrada",
  "CLEAR_ALERTS": "Alertas claros",
  "NO_LOG": "No Log Data",
  "CLICK_DIAL": "Clique para discar",
  "SETTINGS_LOGIN": "Entrar e alterar as configurações",
  "SETTINGS_USER": "As configurações do usuário",
  "SETTINGS_USER_LOGIN": "Entre para alterar as configurações do usuário",
  "MENU_INFO": "Informações Menu",
